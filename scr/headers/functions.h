...
/** Scales a vector after Fourier transforms (FFTW_BACKWARD mode) */
void FFTScale(complex_t *A, uint SIZE)
{
	real_t s = SIZE;
...
void AddPhase(complex_t *A, complex_t *aux, real_t R, real_t delta, uint nn)
{
	for (uint idx = 0; idx < SIZE; idx++){
...
void AddGDD(complex_t *A, complex_t *aux, real_t *w, real_t GDD)
{
...
void AddGDDTOD(complex_t *A, complex_t *aux, real_t *w, real_t GDD,  real_t TOD)
{
...
void ReadPump( complex_t *Ap, complex_t *Ap_total, int N_rt, uint nn )
{
...
void SaveRoundTrip( complex_t *A_total, complex_t *A, uint nn, uint N_rt ){
...
void PhaseModulatorIntraCavity(complex_t *A, complex_t *aux, real_t m, real_t fpm, real_t *T)
{

...
# nvcc OPO.cu -DCW_OPO -DPPLN -I /usr/local/include -L /usr/local/include/fftwf3 -lfftw3 -lfftw3f -lm -o OPO
...
GD=(0 100)                             # GDD compensation (in percent %)                            (ARG7)
TD=(0)                               # TOD compensation (in percent %)                            (ARG8)
UPM=(1)                              # Using phase modulator: OFF/ON = 0/1                        (ARG9)
MD=(0.8)                             # EOM: β (modulation depth in π rads)                        (ARG10)
FM=(2)                               # δf = FSR - fpm [MHz] Frequency detuning for EOM            (ARG11)

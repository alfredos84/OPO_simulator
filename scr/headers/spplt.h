...
const real_t deff		= 10.00e-6;  // Eff. second-order susceptibility [um/V]
const real_t Lambda25C	= 7.97;      // grating period for QPM [μm] 
 ...
 * OUTPUT:
 *     n: refractive index as a funcion of wavelength
 */
...
real_t group_vel(real_t L,real_t T){
...
/** Returns thermal expansion for MgO:sPPLT0 */
real_t LambdaT (real_t Temp, real_t Lambda25C)
{
	// Temperature in Celsius degrees
	return Lambda25C*(1.6e-5*(Temp-25)+7e-9*pow((Temp-25),2));
} 
